...
Call log:
  - waiting for locator('button:has-text("ADD TO SHOPPING CART")')
    ...
    at CartPage.addToCart (/home/webosmotic/Documents/BARU/Baru_automation/Baru_automation/Pages/cart.page.js:11:34)
...
```ts
   ...
   6 |       this.viewCartButton = page.locator('button:has-text("VIEW IN CART")');
   7 |     }
   8 |    
   9 |    
  10 |     async addToCart() {
